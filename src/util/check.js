...
function isWordPressDirectory() {
    ...
    if (!fs.existsSync(configPath)) {
      console.error(chalk.red.bold('Error: tugboat.config.js not found in the current directory.'));
      return false;
    }
    ...
    if (!fs.existsSync(wpConfigPath)) {
      console.error(chalk.red.bold('Error: wp-config.php not found in the current directory.'));
      return false;
    }
